...
<div class="container mt-5">
    ...
    <form method="get" class="row g-2 mb-4">
        <div class="col-md-10">
            <input type="text" name="keyword" class="form-control" placeholder="질문을 검색하세요" value="<%= keyword %>">
        </div>
        <div class="col-md-2">
        ...
        <div class="accordion-item mb-2">
            ...
            <div id="collapse<%=faq.id%>" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                    ...
                    %>
                        <div class="mt-2">
                            <a href="faqEdit.jsp?id=<%=faq.id%>" class="btn btn-sm btn-outline-secondary">수정</a>
                            <a href="faqDelete.jsp?id=<%=faq.id%>" class="btn btn-sm btn-outline-danger" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
                        </div>
                    <%
                        }
                    %>
